...
from utils.queries import get_search_results, get_case_ids, get_bwv_hotline_bevinding, get_bwv_hotline_melding
from utils.queries import get_bwv_personen, get_import_adres, get_import_stadia, get_import_wvs
...
class CaseViewSet(ViewSet):
    ...
    def retrieve(self, request, pk):
        case_ids = get_case_ids(pk)[0]
        wng_id = case_ids['wng_id']
        adres_id = case_ids['adres_id']
        real_data = {
