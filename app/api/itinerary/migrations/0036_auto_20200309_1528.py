...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='itinerarysettings',
            name='exclude_stadia',
            field=models.ManyToManyField(related_name='settings_as_exclude_stadia', to='cases.Stadium'),
        ),
        migrations.AlterField(
            model_name='itinerarysettings',
            name='secondary_stadia',
            field=models.ManyToManyField(related_name='settings_as_secondary_stadia', to='cases.Stadium'),
        ),
    ]
